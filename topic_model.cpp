...
private:
    ...
    std::unordered_map<pair<int, std::vector<doc> > > doc_stack;// year - doc_stack
    std::unordered_map<pair<int, std::vector<doc> > > test_doc_stack;
public:
    std::unordered_map<pair<std::srtring, int> > dictionary;
    int dict_len;
    //int doc_num; 
    double test_ratio;
...
private:
    Corpus cps;
    std::unordered_map<pair<int, std::vector<doc_status> > > doc_status_stack;// year -doc_status_stack
    std::unordered_map<pair<int, std::vector<doc_status> > > test_doc_status_stack;
